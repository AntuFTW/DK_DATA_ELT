with stock_events as (
    select
        ...
        CREATED_AT as FCT_STOCK_UPDATE_CREATED_AT,
        UPDATED_AT as FCT_STOCK_UPDATE_UPDATED_AT,
...
select
    row_number() over (order by FCT_STOCK_UPDATE_CREATED_AT) as FCT_STOCK_UPDATE_ID,
    *
from
    stock_events